...
BASE_SAVE_DIR = f'logs/25-12-09-cheetah-run_initial_conditions_seeds_models'
...
def main():
    ...
    for config in CONFIGS:
        ...
        if config['multitask']:
            ...
            TASK_IDX = 3  # cheetah-run is at index 3 in the mt30 task list
        else:
            cfg.task = 'cheetah-run'
            cfg.multitask = False
            cfg.checkpoint = f'ckpts/cheetah-run-3.pt'
            TASK_IDX = None
